...
namespace SHStudentScoreAvgReport
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            rbItem2["報表"]["成績相關報表"]["各育成績總表"].Enable = UserAcl.Current["SHClassStudentScoreAvgReport"].Executable;
            ...
            catalog1b.Add(new RibbonFeature("SHClassStudentScoreAvgReport", "各育成績總表"));  
        }
    }
}
